...
protocol CustomSwitchDelegate: class {
    func valueChanged(sender: ___FILEBASENAMEASIDENTIFIER___)
}
...
class ___FILEBASENAMEASIDENTIFIER___: UIView {
    ...
    @IBInspectable var onBallSize: CGFloat = 0 {
        didSet {
            configBallOn()
            setToCurrentState()
        }
    ...
    @IBInspectable var onBallColor: UIColor = UIColor.white {
        didSet {
            configBallOn()
            setToCurrentState()
        }
    ...
    @IBInspectable var onBallBorderColor: UIColor = UIColor.clear {
        didSet {
            configBallOn()
            setToCurrentState()
        }
    ...
    @IBInspectable var onColorContainer: UIColor = UIColor(red: 83/255, green: 215/255, blue: 105/255, alpha: 1) {
        didSet {
            configContainerOn()
            setToCurrentState()
        }
    ...
    @IBInspectable var onBorderColorContainer: UIColor = UIColor.clear {
        didSet {
            configContainerOn()
            setToCurrentState()
        }
    ...
    @IBInspectable var offBallSize: CGFloat = 0 {
        didSet {
            configBallOff()
            setToCurrentState()
        }
    ...
    @IBInspectable var offBallColor: UIColor = UIColor.white {
        didSet {
            configBallOff()
            setToCurrentState()
        }
    ...
    @IBInspectable var offBallBorderColor: UIColor = UIColor.clear {
        didSet {
            configBallOff()
            setToCurrentState()
        }
    ...
    @IBInspectable var offColorContainer: UIColor = UIColor.white {
        didSet {
            configContainerOff()
            setToCurrentState()
        }
    ...
    @IBInspectable var offBorderColorContainer: UIColor = UIColor(white: 0.9, alpha: 1) {
        didSet {
            configContainerOff()
            setToCurrentState()
        }
    ...
    @IBInspectable var ratioBallCorner: CGFloat = 0.5 {
        didSet {
            setToCurrentState()
        }
    }
    
    @IBInspectable var ratioContainerCorner: CGFloat = 0.5 {
        didSet {
            setToCurrentState()
        }
    }
    ...
    func setOn(isAnimate: Bool? = true) {
    ...
    func setOff(isAnimate: Bool? = true) {
