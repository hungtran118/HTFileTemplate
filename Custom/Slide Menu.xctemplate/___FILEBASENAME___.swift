...
open class ___FILEBASENAMEASIDENTIFIER___: UIViewController, UIGestureRecognizerDelegate {
    ...
    @objc open override func toggleRight() {
        if isRightOpen() {
            closeRight()
            setCloseWindowLevel()
...
extension UIViewController {
    ...
    public func slideMenuController() -> ___FILEBASENAMEASIDENTIFIER___? {
        var viewController: UIViewController? = self
        while viewController != nil {
            if viewController is ___FILEBASENAMEASIDENTIFIER___ {
                return viewController as? ___FILEBASENAMEASIDENTIFIER___
            }
